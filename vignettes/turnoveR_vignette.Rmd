...
"protein_sums.csv": a file containing a sum of how many times each protein was identified in each sample of a dataset 
...
"svm_results.csv": typically a massacre output file curated to remove poorly fitted curves 
...
"metadata.xlxs": an excel sheet with sample timepoints, other sampling information 
